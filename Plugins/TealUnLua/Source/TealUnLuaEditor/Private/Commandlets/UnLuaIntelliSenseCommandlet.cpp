...
#include "Commandlets/TealUnLuaIntelliSenseCommandlet.h"
#include "LuaContext.h"

UTealUnLuaIntelliSenseCommandlet::UTealUnLuaIntelliSenseCommandlet(const FObjectInitializer& ObjectInitializer)
...
int32 UTealUnLuaIntelliSenseCommandlet::Main(const FString& Params)
{
	// class black list
	...
	SaveFile(ModuleName, "StaticExp", GeneratedFileContent);
...
void UTealUnLuaIntelliSenseCommandlet::SaveFile(const FString& ModuleName, const FString& FileName, const FString& GeneratedFileContent)
{
	IFileManager& FileManager = IFileManager::Get();
	FString Directory = FPaths::ProjectContentDir() / TEXT("Script") / TEXT("Declaration") / ModuleName;
